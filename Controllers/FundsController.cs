...
namespace WebFund.Controllers
{
    public class FundsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,code,name,value,UpdateDate,ChangeInDay,ChangeInWeek,ChangeInMonth")] Fund fund)
        {
            if (id != fund.Id)
            {
                return NotFound();
